...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { image_name: @level.image_name, name: @level.name, number_of_clicks: @level.number_of_clicks }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { image_name: @level.image_name, name: @level.name, number_of_clicks: @level.number_of_clicks }
    assert_redirected_to level_path(assigns(:level))
  end
